...
const AdminPage = () => {
    ...
    const fetchProducts = async () => {
        try {
            const res = await axios.get('https://project-next-backend.onrender.com/api/products');
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (editingProduct) {
                ...
                await axios.put(`https://project-next-backend.onrender.com/api/products/${id}`, formData);
                showPopup('✅ Cập nhật sản phẩm thành công!', 'success');
                setEditingProduct(null);
            } else {
                await axios.post('https://project-next-backend.onrender.com/api/products', formData);
    ...
    const handleDelete = async (id) => {
        if (window.confirm('Bạn có chắc muốn xoá sản phẩm này không?')) {
            try {
                await axios.delete(`https://project-next-backend.onrender.com/api/products/${id}`);
                fetchProducts();
