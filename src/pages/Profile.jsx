...
const Profile = () => {
    ...
    const handleUpdateProfile = async (e) => {
        ...
        try {
            ...
            const response = await axios.put('https://project-next-backend.onrender.com/api/auth/profile', formData, {
    ...
    const handleChangePassword = async (e) => {
        ...
        try {
            const token = localStorage.getItem('token');
            await axios.put('https://project-next-backend.onrender.com/api/auth/change-password', passwordData, {
                headers: { Authorization: `Bearer ${token}` }
            });
