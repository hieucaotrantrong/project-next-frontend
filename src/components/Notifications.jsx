...
const Notifications = () => {
    ...
    const fetchNotifications = async () => {
        try {
            ...
            const response = await axios.get(`https://project-next-backend.onrender.com/api/notifications/${userEmail}`);
    ...
    const handleMarkAsRead = async (notificationId) => {
        try {
            await axios.put(`https://project-next-backend.onrender.com/api/notifications/${notificationId}/read`);
            fetchNotifications();
        } catch (error) {
