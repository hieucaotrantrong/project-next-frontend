...
export default function WalletManagement() {
    ...
    const fetchDepositRequests = async () => {
        try {
            ...
            const response = await axios.get('https://project-next-backend.onrender.com/api/admin/deposits', {
    ...
    const handleApprove = async (id) => {
        try {
            const token = localStorage.getItem('token');
            await axios.put(`https://project-next-backend.onrender.com/api/admin/deposits/${id}/approve`, {}, {
                headers: { Authorization: `Bearer ${token}` }
            });
    ...
    const handleReject = async (id) => {
        try {
            const token = localStorage.getItem('token');
            await axios.put(`https://project-next-backend.onrender.com/api/admin/deposits/${id}/reject`, {}, {
                headers: { Authorization: `Bearer ${token}` }
            });
            fetchDepositRequests();
